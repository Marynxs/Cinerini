...
O agente apresentou o arranque a frio do Render como desvantagem fixa: dezenas de segundos na primeira requisição depois de inatividade. Perguntei se não daria para disparar o religamento assim que alguém abre o site, antes de clicar em qualquer coisa. Dá, e é o que o front passou a fazer ao montar a página, de modo que a espera corre enquanto a pessoa lê a tela. O que sobra vira aviso explícito, dizendo que o servidor é gratuito e está religando. Isso desempatou a escolha da plataforma a favor do Render, onde o limitador de tentativas e o cache funcionam de verdade — numa função serverless os dois perderiam o efeito.
